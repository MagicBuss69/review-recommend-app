...
const translations = {
  en: {
    ...
    "recommend.tastebtn": "💚 Suits my taste",
    "recos.title": "✨ Recommended for you",
    ...
    "results.tastefoodtitle": "🍕 Food you might like",
    "results.tastefoodsub": "Dishes loved here — your taste-matches first 💚",
    "results.mealtitle": "🍽️ Your perfect meal",
    "results.mealsub": "A full meal from dishes people love here 💚",
  ...
  sv: {
    ...
    "recommend.tastebtn": "💚 Passar min smak",
    "recos.title": "✨ Rekommenderat för dig",
    ...
    "results.tastefoodtitle": "🍕 Mat du kanske gillar",
    "results.tastefoodsub": "Rätter folk älskar här — dina matchningar först 💚",
    "results.mealtitle": "🍽️ Din perfekta måltid",
    "results.mealsub": "En hel måltid av rätter folk älskar här 💚",
