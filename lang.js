...
const translations = {
  en: {
    ...
    "profile.shophint": "Spend points to UNLOCK banners. Once unlocked, switch between them freely! 💎",
  ...
  sv: {
    ...
    "profile.shophint": "Spendera poäng för att LÅSA UPP banners. När de är upplåsta kan du byta fritt! 💎",
